...
func RegisterProfileHandlerClient(ctx context.Context, mux *runtime.ServeMux, client ProfileClient) error {
	...
	mux.Handle("GET", pattern_Profile_Get_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_Profile_Get_0(rctx, inboundMarshaler, client, req, pathParams)
		...
		forward_Profile_Get_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
var (
	pattern_Profile_Get_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2}, []string{"v1", "profile", "id"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Profile_Create_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"v1", "profile"}, "", runtime.AssumeColonVerbOpt(true)))
)
